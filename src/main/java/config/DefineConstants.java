...
public class DefineConstants {
	...
	// Application URL
	public static final String Amazon_URL = "https://www.amazon.ca/";
	...
	public static final String userEmail = "valid_email";
	public static final String userPassword = "valid_password";
	public static final String userMobileNumber = "valid_mobileNo";
	...
	public static final String Login_Details = TestData_Folder + "//" + "UserLoginDetails.json";
